var StarplotCluster = function(container) {
	this.container = containter || null;
};

var starplot = {};

starplot.container = null;
starplot.styles = {
	base: {
		"starplot-base": true
	},
...
starplot.differentialAngle = 360;
starplot.convertToPathData = d3.svg.line.radial()
								   .radius(function(d) {
										return d.radius;
								   })
								   .angle(function(d) {
...
starplot.generatePathData = function(radii) {
...
function drawRadialLine(starPlotSVG, initialRadius, finalRadius, angle, styles) {
	...
	drawPolygon(starPlotSVG, pathData, styles);
}
...
function drawStarPlotBase(starPlotSVG, title, branches, radius, showBranchNames, isAggregatedView) {
	...
	drawPolygon(starPlotSVG, generatePathData(vertices), "starplot-base");
...
function insertSustainableGoalToStarPlot(starPlotSVG, data, radiusScale, styles) {
	...
	drawPolygon(starPlotSVG, generatePathData(scaledData), styles);
}
